"""Initial migration with users and products

Revision ID: 7063e6fc3c3d
Revises: 
Create Date: 2024-10-08 22:44:45.468267
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('attribute_value', name='uq_attribute_value_attribute_id')
    )
